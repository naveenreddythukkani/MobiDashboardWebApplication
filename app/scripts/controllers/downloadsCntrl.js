...
MobiDash.controller('downloadsCntrl', function($scope, $state, $rootScope, $stateParams, $http, domain, api, $timeout,$window, core, localStorageService, NgTableParams, dataMove, session) {
